...
import config
from src.retriever import load_vectorstore, retrieve_documents
...
def generate_answer(context: str, question: str, rag_instructions: str = "") -> RAGResponse:
    """
    调用 LLM 生成结构化答案
...
def ask(question: str, k: int = 5, collection=None) -> str:
    """
    端到端问答（检索 + 生成）
